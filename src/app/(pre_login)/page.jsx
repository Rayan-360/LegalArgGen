...
export default async function Home() {
  ...
  return (
    <div className=" h-screen bg-[url('/light.jpg')] dark:bg-[url('/dark.png')] bg-no-repeat bg-center bg-cover flex flex-col gap-4 justify-center items-center p-3 ">
      ...
      <Link href="/signup" className="border-2 border-black px-6 py-3 rounded-full dark:bg-[#161618] text-black font-semibold hover:bg-black hover:text-white transition-all dark:text-white dark:border-1 dark:border-white">Get Started</Link>
    </div>
  );
}
